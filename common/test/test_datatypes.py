...
class DatapointTest(_DatatypeBaseTest):
    ...
    def test_empty_string(self):
        ...
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.PointDatum.from_string("")

    def test_malformed_floats(self):
        """Ensure invalid string floats raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.PointDatum.from_string("test,0.0,info")
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.PointDatum.from_string("0.0,test,info")

    def test_too_few_fields(self):
        """Ensure strings with too few fields raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.PointDatum.from_string("0.0,0.0")

    def test_empty_info_field(self):
        """Ensure empty info field is OK"""
        result = datatypes.PointDatum.from_string("0.0,0.0,")
    ...
    def test_with_newline_n(self):
        ...
        expected = datatypes.PointDatum(0.0, 0.0, 'info')
    ...
    def test_to_string(self):
        ...
        dp = datatypes.PointDatum(0.0, 0.0, 'info')
...
class StackDataTest(_DatatypeBaseTest):
    ...
    def test_empty_string(self):
        """Ensure empty strings raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.StackDatum.from_string("")

    def test_malformed_floats(self):
        """Ensure invalid string floats raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.StackDatum.from_string("test#A;B")

    def test_too_few_fields(self):
        """Ensure strings with too few fields raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.StackDatum.from_string("test")

    def test_empty_stack_field(self):
        """Ensure empty stack field is OK"""
        result = datatypes.StackDatum.from_string("0#")
    ...
    def test_with_newline_n(self):
        """Ensure from_string copes with newlines"""
        expected = datatypes.StackDatum(0, ('A', 'B'))
...
class SchedEventTest(_DatatypeBaseTest):
    ...
    def test_empty_string(self):
        """Ensure empty strings raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.EventDatum.from_string("")

    def test_malformed_ints(self):
        """Ensure invalid string ints raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.EventDatum.from_string("test#A#(\'B\', \'C\')")

    def test_too_few_fields(self):
        """Ensure strings with too few fields raise a DatatypeException"""
        with self.assertRaises(exceptions.DatatypeException):
            datatypes.EventDatum.from_string("test")

    def test_empty_type_field(self):
        """Ensure empty type field is OK"""
        result = datatypes.EventDatum.from_string("1##(\'track\', \'datum\')")
    ...
    def test_empty_track_field(self):
        ...
        result = datatypes.EventDatum.from_string("1#type#(\'\', \'datum\')")
    ...
    def test_empty_datum_field(self):
        ...
        result = datatypes.EventDatum.from_string("1#type#(\'track\',\'\')")
    ...
    def test_with_newline_n(self):
        """Ensure from_string copes with newlines"""
        expected = datatypes.EventDatum(0, 'type', ('track', 'datum'))
    ...
    def test_to_string(self):
        """Test datapoints are correctly converted to strings."""
        se = datatypes.EventDatum(0, 'type', ('track', 'datum'))
