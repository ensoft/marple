...
from common.data_io import StackDatum, PointDatum, EventDatum
from display.tools.g2 import cpel_writer as cpel_writer
...
class ReaderTest(unittest.TestCase):
    ...
    def test_bad_JSON(self):
        ...
        with self.assertRaises(json.JSONDecodeError):
            common.data_io.read_header(file_object)
...
class CPELTest(SchedTest):
    ...
    example_file = "common/test/example_scheddata.cpel"

    @mock.patch("display.tools.g2.cpel_writer."
                "CpelWriter._insert_object_symbols")
    @mock.patch("display.tools.g2.cpel_writer.CpelWriter._write_symbols")
