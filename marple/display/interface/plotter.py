...
class _PlotContainer:
    ...
    def _create_map(self):
        ...
        :param events: the events whose tracks we want to map to the y axis
                       coords
    ...
    def _assign_colors(self):
        ...
        :param: types: a list of the types of events we want to assign colors to
        :return: a dict described above
        """
        colors = {}
        color_idx = 0
...
class _PlotterWindow(pg.GraphicsWindow):
    ...
    def new_graph_from_filter(self, property, filters):
        ...
        new_plot_container = _PlotContainer(filtered_data,
                                            ['comm', 'pid'])
